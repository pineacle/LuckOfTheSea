...
public final class StringUtils {
    ...
    public static String fixMinecraftFormat(String text) {
    ...
    public static List<String> color(final List<String> input) {
        input.replaceAll(s -> s = format(s));
        return input;
    }

    public static void sendCenteredMessage(@Nullable CommandSender player, String message) {
        ...
        if (player != null) {
            ...
            Bukkit.broadcastMessage(sb + message);
        }
    }
